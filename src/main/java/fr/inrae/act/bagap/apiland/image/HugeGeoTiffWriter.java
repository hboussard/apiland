 ...
 */
public class HugeGeoTiffWriter extends AbstractGridCoverageWriter implements GridCoverageWriter {
    private static final Logger LOGGER = Logging.getLogger(HugeGeoTiffWriter.class);

    private final Map<String, String> metadataKeyValue = new HashMap<String, String>();

    /** Constructor for a {@link GeoTiffWriter}. */
    public HugeGeoTiffWriter(Object destination) throws IOException {
    ...
    /** Constructor for a {@link GeoTiffWriter}. */
    public HugeGeoTiffWriter(Object destination, Hints hints) throws IOException {
    ...
    private boolean writeImage(
        ...
        //
        final TIFFImageWriter writer = null;
