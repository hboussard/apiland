...
public class NormalizedBaudryBurelHeterogeneityCompositionIndex extends MatrixMetric implements CoupleMetric {
	
	private int countCouples = -1;
	
	public NormalizedBaudryBurelHeterogeneityCompositionIndex() {
		super(VariableManager.get("NHET-agg"));
	}
