...
public class ComplexityBaudryBurelHeterogeneityCompositionIndex extends MatrixMetric implements CoupleMetric {
	
	private int countCouples = -1;
	
	public ComplexityBaudryBurelHeterogeneityCompositionIndex() {
		super(VariableManager.get("CHET-agg"));
	}
