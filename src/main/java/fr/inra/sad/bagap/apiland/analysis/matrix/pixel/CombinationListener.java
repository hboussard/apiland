...
public interface CombinationListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CombinationParser#ifcombination}.
	 * @param ctx the parse tree
	 */
	void enterIfcombination(@NotNull CombinationParser.IfcombinationContext ctx);
	/**
	 * Exit a parse tree produced by {@link CombinationParser#ifcombination}.
	 * @param ctx the parse tree
	 */
	void exitIfcombination(@NotNull CombinationParser.IfcombinationContext ctx);
	/**
	 * Enter a parse tree produced by {@link CombinationParser#matrix}.
	 * @param ctx the parse tree
	 */
	void enterMatrix(@NotNull CombinationParser.MatrixContext ctx);
	/**
	 * Exit a parse tree produced by {@link CombinationParser#matrix}.
	 * @param ctx the parse tree
	 */
	void exitMatrix(@NotNull CombinationParser.MatrixContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CombinationParser#elsecombination}.
	 * @param ctx the parse tree
	 */
	void enterElsecombination(@NotNull CombinationParser.ElsecombinationContext ctx);
	/**
	 * Exit a parse tree produced by {@link CombinationParser#elsecombination}.
	 * @param ctx the parse tree
	 */
	void exitElsecombination(@NotNull CombinationParser.ElsecombinationContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CombinationParser#logicalop}.
	 * @param ctx the parse tree
	 */
	void enterLogicalop(@NotNull CombinationParser.LogicalopContext ctx);
	/**
	 * Exit a parse tree produced by {@link CombinationParser#logicalop}.
	 * @param ctx the parse tree
	 */
	void exitLogicalop(@NotNull CombinationParser.LogicalopContext ctx);
	/**
