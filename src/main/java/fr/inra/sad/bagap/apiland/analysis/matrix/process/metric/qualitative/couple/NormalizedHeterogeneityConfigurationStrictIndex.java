...
public class NormalizedHeterogeneityConfigurationStrictIndex extends MatrixMetric implements CoupleMetric {
	
	private int countCouples = -1;
	
	public NormalizedHeterogeneityConfigurationStrictIndex() {
		super(VariableManager.get("NHET-frag-strict"));
	}
