...
public class NormalizedBaudryBurelHeterogeneityIndex extends MatrixMetric implements CoupleMetric {
	
	private int countCouples = -1;
	
	public NormalizedBaudryBurelHeterogeneityIndex() {
		super(VariableManager.get("NHET"));
	}
