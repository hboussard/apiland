...
public class ComplexityBaudryBurelHeterogeneityConfigurationIndex extends MatrixMetric implements CoupleMetric {
	
	private int countCouples = -1;
	
	public ComplexityBaudryBurelHeterogeneityConfigurationIndex() {
		super(VariableManager.get("CHET-frag"));
	}
