...
public class SplineCubic {
	...
	public SplineCubic(int[] xx, double[] ff) {
		double fp1, fpn, h, p;
	...
	public double spline_positive_value(double t) {
		double v = spline_value(t);
		if(v < 0){
	...
	public static void main(String[] args) {
		...
		DecimalFormat format = new DecimalFormat("0.00000", symbols);
