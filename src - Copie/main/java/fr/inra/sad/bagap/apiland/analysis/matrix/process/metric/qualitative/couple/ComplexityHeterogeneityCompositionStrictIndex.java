...
public class ComplexityHeterogeneityCompositionStrictIndex extends MatrixMetric implements CoupleMetric {
	
	private int countCouples = -1;
	
	public ComplexityHeterogeneityCompositionStrictIndex() {
		super(VariableManager.get("CHET-agg-strict"));
	}
